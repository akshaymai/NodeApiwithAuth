...
const allowupdate=['Name','Email','Password','Age','Role','RoleId']
...
resetpassword: async(req,res)=>{
    ...
    try {
        const user=await User.resetpassword(req.body.Email,req.body.CurrentPassword,req.body.RestPassword)
        await user.save()
...
forgetpassword:async (req,res)=>{
    try {
        const password=await User.forgetpassword(req.body.Email);
